...
func (s *Switch) SetThumbProgress(progress float32) {
	if progress < 0 {
		progress = 0
	}
	if progress > 1 {
...
func (s *Switch) TypedKey(e *fyne.KeyEvent) {
